...
var numberField = (name, label) => ({
  type: "number",
  name,
  label
});
var booleanField = (name, label) => ({
  type: "boolean",
  name,
  label
});
var linkFields = [text("href", "Href"), text("label", "Label")];
var link = (name, label) => ({
  type: "object",
  name,
  label,
...
var metric = (name, label, numeric = false) => ({
  type: "object",
  name,
  label,
  list: true,
